                ...
                >
                  ...
                  {tipos.includes("T")  && (
                    <td className="p-2 border-b border-stone-100 text-center font-bold text-blue-700">
                      {!isBreak && blocoT  > 0 ? `${blocoT  * 2}h` : <span className="text-stone-200 font-normal">—</span>}
                    </td>
                  )}
                  {tipos.includes("TP") && (
                    <td className="p-2 border-b border-stone-100 text-center font-bold text-teal-700">
                      {!isBreak && blocoTP > 0 ? `${blocoTP * 2}h` : <span className="text-stone-200 font-normal">—</span>}
                    </td>
                  )}
                  {tipos.includes("PL") && (
                    <td className="p-2 border-b border-stone-100 text-center font-bold text-amber-700">
                      {!isBreak && blocoPL > 0 ? `${blocoPL * 2}h` : <span className="text-stone-200 font-normal">—</span>}
                    </td>
                  )}
                  {tipos.includes("S") && (
                    <td className="p-2 border-b border-stone-100 text-center font-bold text-purple-700">
                      {!isBreak && blocoS  > 0 ? `${blocoS  * 2}h` : <span className="text-stone-200 font-normal">—</span>}
                    </td>
                  )}
