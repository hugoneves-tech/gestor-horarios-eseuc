...
export const ucsIniciais: UC[] = [
  createUcEseuc("uc_mi", "Metodologia de Investigação", "MI", 4, 1, "1.º semestre, fase inicial", 1, 7, "2026-09-09", "2026-10-23", 16, 30, 6, "2 turmas T; TP e PL por subdivisão de cada turma."),
  createUcEseuc("uc_eig", "Enfermagem do Idoso e Geriatria", "EIG", 3, 1, "1.º semestre, fase inicial", 1, 7, "2026-09-09", "2026-10-23", 8, 38, 0, "Inclui interrupção da Latada e feriado de 5/10."),
